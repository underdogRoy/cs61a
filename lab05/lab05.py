...
def add_trees(t1, t2):
    ...
    for i in range(max(len(branches_t1),len(branches_t2))):
        if i< len(branches_t1) and i< len(branches_t2):
            new_branches.append(add_trees(branches_t1[i],branches_t2[i]))
        elif i< len(branches_t1):
            new_branches.append(branches_t1[i])
        else:
            new_branches.append(branches_t2[i])
