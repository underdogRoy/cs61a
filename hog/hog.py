...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    if player_score%10==opponent_score%100//10:
        return 1
    else:
        return 3*abs(player_score%10-opponent_score%100//10)
    # END PROBLEM 2
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy(player_score,opponet_score):
        return n
    return strategy
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # END PROBLEM 9
    max_average_score = 0
    max_num_rolls = 1  # Initialize to 1 roll
    for num_rolls in range(1, 11):  # Consider 1 to 10 rolls
        averaged_roll_function = make_averaged(roll_dice, samples_count)
        average_score = averaged_roll_function(num_rolls, dice)
